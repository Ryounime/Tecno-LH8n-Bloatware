# Disabling Bloatware for Tecno Pova 5 Pro 5G (LH8n)
...
## **✅ Safe to Remove** 
(*Does not affect the system, only additional apps.*)
...
(*May cause minor disruption to certain features.*)
...
## **⛔ Risky to Remove**
(*May cause bootloop or system instability.*)
